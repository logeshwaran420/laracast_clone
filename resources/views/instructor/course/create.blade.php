...
<x-heading.main-head title="New Series">
    Share your knowledge. Teach what you know. We'll handle the rest.
</x-heading.main-head>

<div class="flex items-center justify-center bg-gray-900 px-8 py-12">
    <form action="{{ route('instructor.courses.store') }}" method="POST" class="w-full max-w-4xl">
        @csrf
